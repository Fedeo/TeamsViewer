...
export function TopMenu() {
  ...
  const handleRefresh = async () => {
    ...
    try {
      ...
      // Also explicitly refetch to ensure it happens immediately
      await queryClient.refetchQueries({ 
        queryKey: queryKeys.scheduler.all,
        type: 'active'
      });
      console.log('[TopMenu] Data refreshed successfully');
    } catch (error) {
      console.error('[TopMenu] Error refreshing data:', error);
    } finally {
    ...
    <header className={styles.header}>
      ...
      <div className={styles.actions}>
        ...
        <button 
          ...
          title="Reload data from IFS Cloud"
        >
          <svg 
